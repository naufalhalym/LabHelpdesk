                                    ...
                                    <div class="btn-group" role="group">
                                        ...
                                        <form id="form-delete-{{ $data->id_tindak_lanjut }}"
                                            ...
                                            <button type="button" class="btn btn-sm btn-danger"
                                                onclick="confirmDelete('{{ $data->id_tindak_lanjut }}', 'Hapus data tindak lanjut ini?', 'Menghapus data tindak lanjut akan menghapus data yang terkait pada tindak lanjut ini dan Teknisi harus menindaklanjuti ulang permintaan.')">
