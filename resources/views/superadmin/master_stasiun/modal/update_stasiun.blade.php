        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modal_update_stasiunLabel">Update Data Laboratorium</h5>
                ...
                <div class="modal-body">
                    <form action="/superadmin/crud/{{ $data->id_stasiun }}" method="POST" id="form-tambah-pegawai">
                        ...
                        <div class="form-group">
                            <label for="id_stasiun_update">ID Laboratorium</label>
                            <input
                        ...
                        <div class="form-group">
                            <label for="nama_stasiun_update">Nama Laboratorium</label>
