    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalTambahStasiunLabel">Tambah Data Laboratorium</h5>
            ...
            <div class="modal-body">
                <form action="/superadmin/crud" method="POST" id="form-tambah-stasiun">
                    ...
                    <div class="form-group">
                        <label for="id_stasiun">ID Laboratorium</label>
                        <input
                    ...
                    <div class="form-group">
                        <label for="nama_stasiun">Nama Laboratorium</label>
