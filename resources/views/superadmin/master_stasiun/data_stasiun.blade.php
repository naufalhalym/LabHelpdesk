        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header py-3">
                    <div class="row">
                        <h4 class="card-title mx-2">Data Laboratorium</h4>
                        <p class="small text-gray-800">Daftar laboratorium terdaftar di sistem</p>
                    </div>
                </div>
                <div class="row ml-2 mt-2">
                    <div class="col-md-12">
                        <button type="button" class="btn-primary btn-sm float-left" data-bs-toggle="modal"
                            ...
                            <i class="fa fa-plus"></i> Tambah Laboratorium
                        </button>
                    </div>
                </div>
                <div class="card-body">
                                ...
                                @foreach ($data_stasiun as $data)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <button title="Update laboratorium" class="btn btn-sm btn-warning text-white" data-bs-toggle="modal"
                                            ...
                                            <form id="form-delete-{{ $data->id_stasiun }}"
                                                ...
                                                <button type="button" class="btn btn-sm btn-danger"
                                                    onclick="confirmDelete('{{ $data->id_stasiun }}', 'Hapus data laboratorium {{ $data->nama_stasiun }}?','Data laboratorium {{ $data->nama_stasiun }} akan dihapus!')">
