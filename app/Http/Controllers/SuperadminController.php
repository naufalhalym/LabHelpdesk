...
class SuperadminController extends Controller
{
    ...
    public function store(Request $request)
    {
        if ($request->has('email')) {
            ...
            $request->validate(
                ...
                [
                    'id_stasiun.required' => 'ID laboratorium wajib diisi!',
                    'id_stasiun.unique' => 'ID laboratorium sudah ada!',
                    'nama_stasiun.required' => 'Nama laboratorium wajib diisi!',
                    'nama_stasiun.unique' => 'Nama laboratorium sudah ada!',
                ]
            );
            ...
            return $input_stasiun
                ? redirect('/superadmin/master_stasiun')->with('toast_success', 'Data laboratorium berhasil ditambahkan!')
                : redirect('/superadmin/master_stasiun')->with('toast_error', 'Input data laboratorium gagal, silakan coba lagi!');
            ...
            $request->validate([
                ...
                'lokasi_pegawai.required' => 'laboratorium tidak boleh kosong!',
            ]);
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($request->has('nip_pegawai_update')) {
            ...
            $request->validate(
                ...
                [
                    ...
                    'nama_pegawai_update.required' => 'Nama kepala laboratorium wajib diisi!',
                    'bagian_pegawai_update.required' => 'Unit/bagian pegawai wajib diisi!',
                    'jabatan_pegawai_update.required' => 'Jabatan kepala laboratorium wajib diisi!',
                    'lokasi_pegawai_update.required' => 'Pilih laboratorium pegawai!',
                ]
            ...
            if ($this->modelsuperadmin->update_pegawai($data, $id)) {
                return redirect('/superadmin/datapegawai')->with('toast_success', 'Data kepala laboratorium berhasil diupdate!');
            } else {
                return redirect('/superadmin/datapegawai')->with('toast_error', 'Data kepala laboratorium gagal diupdate!');
            }
        }
        ...
        if ($request->input('jenis_input') == 'data_stasiun') {
            $request->validate(
                ...
                [
                    'id_stasiun_update.required' => 'ID laboratorium wajib diisi!',
                    'id_stasiun_update.unique' => 'ID laboratorium sudah ada!',
                    'nama_stasiun_update.required' => 'Nama laboratorium wajib diisi!',
                    'nama_stasiun_update.unique' => 'Nama laboratorium sudah ada!',
                ]
            );
            ...
            return $update_stasiun
                ? redirect('/superadmin/master_stasiun')->with('toast_success', 'Data laboratorium berhasil diupdate!')
                : redirect('/superadmin/master_stasiun')->with('toast_error', 'Update data laboratorium gagal, silakan coba lagi!');
        }
    ...
    public function destroy(Request $request, string $id)
    {
        if ($request->has('hapus_user')) {
            ...
            if ($pegawaiCount > 0) {
                // Jika ada pegawai yang menggunakan data permintaan, kembalikan respons dengan pesan peringatan
                return back()->with('toast_error', 'Tidak bisa hapus kepala laboratorium karena masih terkait pada data permintaan!');
            }
            ...
            return $hapus_pegawai
                ? back()->with('toast_success', 'kepala laboratorium berhasil dihapus!')
                : back()->with('toast_error', 'kepala laboratorium gagal dihapus!');
            ...
            if ($pegawaiCount > 0) {
                ...
                return back()->with('toast_error', 'Tidak dapat menghapus laboratorium karena masih digunakan oleh data pegawai!');
            }
            ...
            return $deleted
                ? back()->with('toast_success', 'Data laboratorium berhasil dihapus!')
                : back()->with('toast_error', 'Data laboratorium gagal dihapus!');
